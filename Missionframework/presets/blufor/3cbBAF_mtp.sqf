...
HAWKESTFS_free_helo_classname = "RHS_UH60M_d";                              // HAWKESTFS Additional freebies at start
HAWKESTFS_free_uav_classname = "B_T_UAV_03_dynamicLoadout_F";               // HAWKESTFS Additional freebies at start

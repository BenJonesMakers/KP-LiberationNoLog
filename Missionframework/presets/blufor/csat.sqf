...
HAWKESTFS_free_plane_classname = "O_Plane_CAS_02_dynamicLoadout_F";     // HAWKESTFS Additional freebies at start
HAWKESTFS_free_helo_classname = "O_Heli_Light_02_dynamicLoadout_F";     // HAWKESTFS Additional freebies at start
HAWKESTFS_free_uav_classname = "O_T_UAV_04_CAS_F";                      // HAWKESTFS Additional freebies at start

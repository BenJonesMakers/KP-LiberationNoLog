...
HAWKESTFS_free_plane_classname = "JS_JC_FA18E";                         // HAWKESTFS Additional freebies at start
HAWKESTFS_free_helo_classname = "RHS_UH60M_ESSS";                       // HAWKESTFS Additional freebies at start
HAWKESTFS_free_uav_classname = "B_UAV_02_dynamicLoadout_F";             // HAWKESTFS Additional freebies at start
